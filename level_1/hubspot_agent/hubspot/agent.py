...
system_prompt = """
    ...
    2. Create a dict with the following properties:
            [ "email": <email from message>,
                ...
                "lifecyclestage": "lead"]
    3. Invoke the create_lead tool with the appropriate json.
    
    TOOLS AVAILABLE:
    
    create_lead:
    - Description: Creates a new lead in HubSpot. Accepts a single parameter `json_payload` which must be a `dict` object containing the lead's properties.
